...
export const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside className={cn(
                "fixed lg:static inset-y-0 left-0 w-72 border-r border-border bg-muted/80 lg:bg-muted/30 flex flex-col transition-all duration-300 z-50 backdrop-blur-xl",
                isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0",
                "lg:w-72" // Fixed width for now to keep it simple
            )}>
